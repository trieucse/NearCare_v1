...
import placeholderLarge from "../images/placeholderlarge.png";
import placeholderLargeDark from "../images/placeholderlargedark.png";
import placeholderLargeH from "../images/placeholderlargeh.png";
import placeholderLargeDarkH from "../images/placeholderlargedarkh.png";
...
const NcImage: FC<NcImageProps> = ({
  ...
  return (
    ...
    >
      {__src ? (
        <img src={__src.toString()} className={className} alt={alt} {...args} />
      ) : (
        <div
