    ...
    >
      ...
      {!!viewAll.href && (
        <Link
          href={viewAll.href}
        >
          <a   rel="noopener noreferrer" className="flex-shrink-0 block text-primary-700 dark:text-primary-500 font-semibold text-sm"  target={viewAll.targetBlank ? "_blank" : undefined}>
          {viewAll.label}
          </a>
        </Link>
      )}
