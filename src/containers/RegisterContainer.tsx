  ...
  useEffect(() => {
    const loadContract = async () => {
      ...
      try {
        ...
        user = await window.contract.get_user({ user_id: window.accountId });
        ...
        const content = await axios.get<{ meta: NearAuthorType }>(
          `https://ipfs.io/ipfs/${base_uri_content}`
        );
        const { avatar, bgImage, displayName, email, desc, jobName, href } =
          content.data.meta;
